...
awful.spawn.once("firefox", { tag = "web" })
awful.spawn.once("steam", { tag = "steam" })
awful.spawn.once("discord", { tag = "dc" })
run_once({ "unclutter --root --timeout 10 --ignore-scrolling" }) -- comma-separated entries
...
awful.util.tagnames = { "web", "steam", "dc", "4", "5", "6", "7", "8", "9" }
